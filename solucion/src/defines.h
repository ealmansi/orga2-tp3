...
#define TASK_2_PAGE_TABLE		0x00039000 /* direccion fisica para la tabla de paginas de la tarea 2 */
#define TASK_3_PAGE_TABLE		0x0003A000 /* direccion fisica para la tabla de paginas de la tarea 3 */
#define TASK_4_PAGE_TABLE		0x0003B000 /* direccion fisica para la tabla de paginas de la tarea 4 */
#define TASK_5_PAGE_TABLE		0x0003C000 /* direccion fisica para la tabla de paginas de la tarea 5 */
#define TASK_6_PAGE_TABLE		0x0003D000 /* direccion fisica para la tabla de paginas de la tarea 6 */
#define TASK_7_PAGE_TABLE		0x0003E000 /* direccion fisica para la tabla de paginas de la tarea 7 */
#define TASK_8_PAGE_TABLE		0x0003F000 /* direccion fisica para la tabla de paginas de la tarea 8 */
...
#define ADDR_IDLE_PAGE_TABLE	 		0x0002B000
